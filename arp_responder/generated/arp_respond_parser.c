...
/* extract(hdr->arp) */
            ...
            hdr->arp.htype = (u16)((load_half_ne(pkt, BYTES(ebpf_packetOffsetInBits))));
            ebpf_packetOffsetInBits += 16;

            hdr->arp.ptype = (u16)((load_half_ne(pkt, BYTES(ebpf_packetOffsetInBits))));
            ebpf_packetOffsetInBits += 16;
            ...
            hdr->arp.oper = (u16)((load_half_ne(pkt, BYTES(ebpf_packetOffsetInBits))));
            ebpf_packetOffsetInBits += 16;
...
/* extract(hdr->arp_ipv4) */
            ...
            hdr->arp_ipv4.sha = (u64)((load_dword_ne(pkt, BYTES(ebpf_packetOffsetInBits)) >> 16) & EBPF_MASK(u64, 48));
            ebpf_packetOffsetInBits += 48;

            hdr->arp_ipv4.spa = (u32)((load_word_ne(pkt, BYTES(ebpf_packetOffsetInBits))));
            ebpf_packetOffsetInBits += 32;

            hdr->arp_ipv4.tha = (u64)((load_dword_ne(pkt, BYTES(ebpf_packetOffsetInBits)) >> 16) & EBPF_MASK(u64, 48));
            ebpf_packetOffsetInBits += 48;

            hdr->arp_ipv4.tpa = (u32)((load_word_ne(pkt, BYTES(ebpf_packetOffsetInBits))));
            ebpf_packetOffsetInBits += 32;
...
;
            u16 select_0;
            select_0 = bpf_ntohs(hdr->arp.oper);
