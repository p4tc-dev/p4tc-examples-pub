...
/* extract(hdr->ipv6) */
            ...
            hdr->ipv6.traffiClass = (u8)((load_half(pkt, BYTES(ebpf_packetOffsetInBits)) >> 4) & EBPF_MASK(u8, 8));
            ...
            hdr->ipv6.payloadLen = (u16)((load_half(pkt, BYTES(ebpf_packetOffsetInBits))));
            ebpf_packetOffsetInBits += 16;

            hdr->ipv6.nextHdr = (u8)((load_byte(pkt, BYTES(ebpf_packetOffsetInBits))));
            ebpf_packetOffsetInBits += 8;
...
;
            u8 select_0;
            select_0 = hdr->ipv6.nextHdr;
            if (select_0 == 0x6)goto parse_tcp;
            if (select_0 == 0x11)goto parse_udp;
...
;
            ...
            if (select_1 == 0x86dd)goto parse_ipv6;
