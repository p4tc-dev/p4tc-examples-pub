/* Automatically generated by p4c-pna-p4tc from /home/vnogueira/kvmshare/p4tc-examples/tunnels/ipip/ipip.p4 on Tue Mar  5 13:13:58 2024
 */
...
/* fwd_table_0.apply() */
                {
                    ...
                    /* perform lookup */
                    act_bpf = bpf_p4tc_tbl_read(skb, &params, sizeof(params),
						&key, sizeof(key));
                    ...
                    if (value != NULL) {
                        ...
                        switch (value->action) {
                            case MAIN_FWD_TABLE_ACT_MAIN_SET_IPIP: 
                                {
                                    meta->src = bpf_htonl(value->u.Main_set_ipip.src);
                                    meta->dst = bpf_htonl(value->u.Main_set_ipip.dst);
                                    meta->push = true;
                            ...
                            case MAIN_FWD_TABLE_ACT_MAIN_SET_NH: 
                                {
                                    hdr->ethernet.dstAddr = ntohll(value->u.Main_set_nh.dmac) >> 16;
