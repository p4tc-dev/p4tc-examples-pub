/* Automatically generated by p4c-pna-p4tc from redirect_l2.p4 on Wed Nov  8 21:13:22 2023
 */
                ...
                if (value != NULL) {
                    ...
                    switch (value->action) {
                        case INGRESS_NH_TABLE_ACT_INGRESS_SEND_NH: 
                            {
                                hdr->ethernet.srcAddr = ntohll(value->u.ingress_send_nh.smac);
                                hdr->ethernet.dstAddr = ntohll(value->u.ingress_send_nh.dmac);
...
int tc_ingress_func(struct __sk_buff *skb) {
    ...
    int ret = process(skb, (struct my_ingress_headers_t *) hdr, compiler_meta__);
